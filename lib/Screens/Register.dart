  ...
  Widget _heading() {
    return Column(
      ...
      children: [
        ...
        const Text(
          'Join PennyPal to start budgeting smarter',
          style: TextStyle(fontSize: 15.5, color: AppColors.body),
        ),
      ],
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        const Padding(
          ...
          child: Text(
            'Must contain 1 number & 1 special character',
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  'Complete onboarding to unlock your first automatic savings deposit.',
                  style: TextStyle(
                    fontSize: 13.5,
                    height: 1.35,
                    color: AppColors.body,
