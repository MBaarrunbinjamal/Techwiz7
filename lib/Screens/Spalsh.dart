...
class SplashColors {
  ...
  static const deepGreen = Color(0xFF0B6E3B);
...
class _SplashState extends State<Splash> with SingleTickerProviderStateMixin {
  ...
  void _openNext() {
    ...
    Navigator.pushReplacementNamed(context, user != null ? '/home' : '/chose');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Positioned(top: -60, right: -80, child: _glow(260, trackColor)),
          Positioned(bottom: -70, left: -80, child: _glow(240, chipColor)),
          _betaTag(chipColor),
